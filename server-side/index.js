...
const passportSetupGoogle = require('./app/passport/passport-setup-google');
const passportSetupFacebook = require('./app/passport/passport-setup-facebook');
...
app.all('*', function(req, res, next) {
    res.header("Access-Control-Allow-Origin", "http://trackitdown.co.in");
